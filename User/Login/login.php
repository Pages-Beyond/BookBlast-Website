...
<head>
  ...
  <link rel="icon" type="image/x-icon" href="../../assets/img/login/bookblast-logo.png" />
        ...
        <form method="POST">
          ...
          <div class="d-flex justify-content-center">
            ...
            <div class="ms-4 sign-up-button-container">
              ...
              <button class="btn sign-up-btn" onclick="document.location.href='../Sign Up/signUp.php'">Sign Up</button>
